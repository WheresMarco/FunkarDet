class GroupsController < ApplicationController
  ...
  def show
    if !current_user.organizer
      ...
      @group_dates_organizer = @group.group_dates.joins('LEFT JOIN group_date_attendances ON group_date_attendances.group_date_id = group_dates.id').group('group_dates.id').order(from_date: :asc)
    end
  end
